...
class choh_fastmri_brain_hybrid_ifft_regular_acs32R4_test(Dataset):
	def __init__(self, num_total_set = 59):
		print('\n  Dataset : choh_fastmri_brain_hybrid_ifft_regular_acs32R4_test')
...
class choh_fastmri_brain_hybrid_ifft_fixed_acs32R4_test(Dataset):
	def __init__(self, num_total_set = 59):
		print('\n  Dataset : choh_fastmri_brain_hybrid_ifft_fixed_acs32R4_test')
		...
		idx_part1 = np.load('R4_idx_part1.npy')
		idx_part2 = np.load('R4_idx_part2.npy')
